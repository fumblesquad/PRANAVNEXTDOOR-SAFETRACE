...
function MapIcon({ active }) {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#D4537E' : 'rgba(255,255,255,0.35)'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {TABS.map(({ id, label, Icon }) => {
          ...
          return (
            ...
            >
              ...
              <span style={{
                fontSize: '10px',
                color: active ? '#D4537E' : 'rgba(255,255,255,0.35)',
